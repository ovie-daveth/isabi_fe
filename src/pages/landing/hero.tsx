    ...
    <div className="flex gap-5 max-md:flex-col">
      <div className="flex flex-col w-[45%] max-md:ml-0 max-md:w-full">
        <div className="flex z-10 flex-col items-start mt-11 mr-0 w-full font-medium text-zinc-600 max-md:mt-10 max-md:max-w-full">
          ...
          <h1 className="self-stretch mt-8 lg:text-8xl text-5xl font-bold tracking-tighter text-neutral-900 max-md:max-w-full max-md:text-4xl max-md:leading-10">
      ...
      <div className="flex flex-col ml-5 w-[55%] max-md:ml-0 max-md:w-full lg:mt-0 mt-20">
        <div className="flex relative flex-col grow items-end px-20 pt-10 pb-20 max-md:px-5 max-md:max-w-full">
          <img
            loading="lazy"
