...
const CallToAction: React.FC = () => {
  return (
    <div className="flex flex-wrap gap-10 items-center px-20 py-24 mt-32 w-full bg-slate-950 max-w-[1290px] rounded-[42px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-col flex-1 shrink self-stretch my-auto font-semibold text-white basis-0 min-w-[240px] max-md:max-w-full">
      ...
      <div className="flex flex-col items-start self-stretch my-auto min-w-[240px] w-[495px] max-md:max-w-full">
        <div className="flex flex-col max-w-full w-[410px]">
          ...
          <div className="flex gap-10 items-center mt-6 w-full">
            ...
            <div className="flex gap-0 items-center self-stretch p-1.5 my-auto text-sm font-extrabold leading-tight text-center whitespace-nowrap bg-white rounded-[29px] text-neutral-900">
              <img
                loading="lazy"
              ...
              <img
                ...
                className="object-contain shrink-0 self-stretch my-auto rounded-full aspect-square w-[38px]"
              />
              <div className="self-stretch px-2 my-auto rounded-2xl bg-zinc-100 h-[39px] min-h-[38px] w-[39px]">
                +23
              </div>
            </div>
          </div>
