...
const SignIn = () => {
  ...
  return (
    <AuthLayout  setOpen={setLoading} loadingMessage="Loading your account, Please wait..." loading={loading} progress={1} title="Sign in" openToast={openToast} setOpenToast={setOpenToast} toastTitle="Login OTP sent" toastMessage="Login opt sent to mail">
      <div>
